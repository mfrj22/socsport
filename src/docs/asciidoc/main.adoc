...
Pour visualiser la structure du modèle, nous avons créé un diagramme UML à l'aide de PlantUML. Voici le contenu du fichier `model.puml` :

[plantuml, model.puml]
----
!includeurl https://raw.githubusercontent.com/plantuml/plantuml-icon-font-sprites/v1.2023.3/common.puml
